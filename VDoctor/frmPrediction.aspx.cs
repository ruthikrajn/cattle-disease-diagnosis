    ...
    public partial class frmPrediction : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lbtnDiseaseName.Text = "obstetric-disease";
                }
                ...
                {
                    lbtnDiseaseName.Text = "poisoning-diseases";
                }
                else
                {
        ...
        protected void lbtnDiseaseName_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lbtnDiseaseName.Text.Equals("poisoning-diseases"))
                {
                    lblTreatment.Text = "Treatment Details: " + "thiamine-hydrochloride-(vitamin B1)(T),magnesium-sulfate(T),sodium-calcium-edentate(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("obstetric-disease"))
                {
                    lblTreatment.Text = "Treatment Details: " + "TANUVAS-Mineral-mixture(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("bruise"))
                {
                    lblTreatment.Text = "Treatment Details: " + "dehorning-of-calves(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("Lack-of-milk"))
                {
                    lblTreatment.Text = "Treatment Details: " + "antibiotics(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("Uterine-prolapse"))
                {
                    lblTreatment.Text = "Treatment Details: " + "pessary(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("gonorrhea"))
                {
                    lblTreatment.Text = "Treatment Details: " + "antibiotics(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("trauma"))
                {
                    lblTreatment.Text = "Treatment Details: " + "penicillin(T),broad-spectrum(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("asthma"))
                {
                    lblTreatment.Text = "Treatment Details: " + "palliative-therapy(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("Spleen-diarrhea"))
                {
                    lblTreatment.Text = "Treatment Details: " + "anthelminthics(T),anti-inflammatories(T),rehydration-fluids(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("Cold"))
                {
                    lblTreatment.Text = "Treatment Details: " + "antibiotics(T)";
                }
                else if (lbtnDiseaseName.Text.Equals("Ssis"))
                {
                    lblTreatment.Text = "Treatment Details: " + "antibiotics(T)";
                }
                else
